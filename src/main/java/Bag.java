...
public abstract class Bag {
     ...
     *
     * @return the last item in the contents that has now been removed. If array is empty, returns null.
     */
    public Object popItem(){
        if (this.numberOfContents == 0) {
            ...
            this.numberOfContents --;
            String x = this.contents[numberOfContents];
